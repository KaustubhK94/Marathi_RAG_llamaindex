...
- along with Tesseract's Marathi train data [Click Here to Download](https://tesseract-ocr.github.io/tessdoc/Data-Files) copied to `C:\Program Files\Tesseract-OCR\tessdata`
